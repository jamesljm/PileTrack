...
export function DiaphragmWallForm({ control, siteId }: DiaphragmWallFormProps) {
    ...
    <div className="space-y-3">
      ...
      <CollapsibleSection title="Details" defaultOpen>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField control={control} name="panelId" render={({ field }) => (
            <FormItem><FormLabel>Panel ID</FormLabel><FormControl><Input placeholder="DW-P01" className="min-h-[44px]" {...field} /></FormControl><FormMessage /></FormItem>
          )} />
          <FormField control={control} name="panelSequence" render={({ field }) => (
            <FormItem><FormLabel>Panel Sequence</FormLabel><FormControl><Input type="number" className="min-h-[44px]" {...field} onChange={e => field.onChange(Number(e.target.value))} /></FormControl><FormMessage /></FormItem>
          )} />
        </div>
          ...
          <FormField control={control} name="excavationMethod" render={({ field }) => (
            <FormItem><FormLabel>Excavation Method</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}><FormControl><SelectTrigger className="min-h-[44px]"><SelectValue placeholder="Select method" /></SelectTrigger></FormControl>
                <SelectContent><SelectItem value="GRAB">Grab</SelectItem><SelectItem value="CUTTER">Cutter</SelectItem><SelectItem value="HYDROMILL">Hydromill</SelectItem></SelectContent>
              </Select><FormMessage /></FormItem>
          )} />
          <FormField control={control} name="jointType" render={({ field }) => (
            <FormItem><FormLabel>Joint Type</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}><FormControl><SelectTrigger className="min-h-[44px]"><SelectValue placeholder="Select type" /></SelectTrigger></FormControl>
                <SelectContent><SelectItem value="CWS">CWS</SelectItem><SelectItem value="STOP_END">Stop End</SelectItem><SelectItem value="CUTTER">Cutter</SelectItem></SelectContent>
              </Select><FormMessage /></FormItem>
          )} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <FormField control={control} name="slurryLevel" render={({ field }) => (
            <FormItem><FormLabel>Slurry Level (m)</FormLabel><FormControl><Input type="number" step="0.1" className="min-h-[44px]" {...field} onChange={e => field.onChange(Number(e.target.value))} /></FormControl><FormMessage /></FormItem>
          )} />
          <FormField control={control} name="slurryDensity" render={({ field }) => (
            <FormItem><FormLabel>Slurry Density (g/cm3)</FormLabel><FormControl><Input type="number" step="0.01" className="min-h-[44px]" {...field} onChange={e => field.onChange(Number(e.target.value))} /></FormControl><FormMessage /></FormItem>
          )} />
        </div>
        <div className="mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <FormField control={control} name="guideWallLevel" render={({ field }) => (
            <FormItem><FormLabel>Guide Wall Level (m)</FormLabel><FormControl><Input type="number" step="0.01" className="min-h-[44px]" {...field} onChange={e => field.onChange(Number(e.target.value))} /></FormControl><FormMessage /></FormItem>
          )} />
          <FormField control={control} name="overbreak" render={({ field }) => (
            <FormItem><FormLabel>Overbreak (m3) - Optional</FormLabel><FormControl><Input type="number" step="0.1" className="min-h-[44px]" {...field} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : undefined)} /></FormControl><FormMessage /></FormItem>
          )} />
        </div>
      </CollapsibleSection>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <FormField control={control} name="tremiePipeCount" render={({ field }) => (
            <FormItem><FormLabel>Tremie Pipe Count</FormLabel><FormControl><Input type="number" className="min-h-[44px]" {...field} onChange={e => field.onChange(Number(e.target.value))} /></FormControl><FormMessage /></FormItem>
          )} />
        </div>
